...
**Note that FRINX ODL Distribution 1.4.11 requires Java 8**\ :raw-html-m2r:`<br>`
...
#. Removed schema export and models.json file
#. Added percentage hint to daexim import
#. Introduced daexim.importTimeoutMillis

**Distribution:**  


#. Switched gc collector to G1, use 4GB for heap by default, add gc logs to log folder
#. Added switch to crash JVM on out of memory
#. Added best effort check for other running karaf instances
#. Better naming for extracted yang schemas - use module@revision.yang
#. Extract yang files from system folder during startup schema import
#. Fixed status and stop command

**BGP:**  


#. Export org.opendaylight.groupbasedpolicy.resolver
