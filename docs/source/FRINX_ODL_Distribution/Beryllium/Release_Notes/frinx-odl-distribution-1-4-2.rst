...
#. :raw-html-m2r:`<span class="line">Add ability to ignore nodes from specific namespaces in ALU customization of netconf connector.</span>`
#. :raw-html-m2r:`<span class="line">Fix race condition in Restconf - fix detection of empty body of HTTP request.</span>`
#. :raw-html-m2r:`<span class="line">Support of SROS 14.0R04 - new ALU customization that ignores candidate capability.</span>`
#. :raw-html-m2r:`<span class="line">Fix writing to inventory nodes by netconf connector.</span>`
