...
**Note that FRINX ODL Distribution 1.4.12 requires Java 8**\ :raw-html-m2r:`<br>`
...
#. Don't set begin and commit to policy-options
#. Don't copy running config to startup config on cleanup
#. Fix ALU sending malformed XML messages

**Controller:**  


#. Move karaf configuration from distribution to opendaylight-karaf-resources
